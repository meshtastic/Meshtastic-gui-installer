...
class EnvironmentalMeasurementForm(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        form_layout.addRow(self.tr("Recovery interval"), self.environmental_measurement_plugin_recovery_interval)
        form_layout.addRow(self.tr("Screen enabled?"), self.environmental_measurement_plugin_screen_enabled)
        form_layout.addRow(self.tr("Sensor pin"), self.environmental_measurement_plugin_sensor_pin)
        form_layout.addRow(self.tr("Sensor type"), self.environmental_measurement_plugin_sensor_type)
        form_layout.addRow(self.tr("Update interval"), self.environmental_measurement_plugin_update_interval)
