...
class ExternalNotificationsForm(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        form_layout.addRow(self.tr("Enabled?"), self.ext_notification_plugin_enabled)
        form_layout.addRow(self.tr("Output"), self.ext_notification_plugin_output)
        form_layout.addRow(self.tr("Output (ms)"), self.ext_notification_plugin_output_ms)
